...
export type PvpProgram = {
  ...
  instructions: [
    ...
    {
      name: "joinSide";
      discriminator: [72, 81, 137, 98, 213, 63, 154, 117];
      accounts: [
        {
          name: "lobby";
          writable: true;
  ...
  accounts: [
    {
      name: "activeLobby";
      discriminator: [32, 130, 43, 176, 36, 236, 20, 114];
    },
    {
      name: "globalConfig";
    ...
    },
    {
      ...
      discriminator: [164, 207, 200, 51, 199, 113, 35, 109];
    },
    {
      name: "permissionAccountData";
      discriminator: [77, 37, 177, 164, 38, 39, 34, 109];
    }
  ];
  errors: [
    {
